...
#define META_DATA_LINE_SIZE 1024
...
#define START_TIME_STRING                 "Start time\" (\"Acquisition start time\")"
...
#define TIMEPIX_CLOCKINMHZ_STRING 		  "Timepix clock (in MHz)"
#define TIMEPIX_CLOCKINMHZ_EXTRA 		  "double[1]"
#define TIMEPIX_CLOCKINMHZ_CODE 		  281
...
#define ASCII_FRAME_TYPE_STRING  "A000000001"
#define ASCII_MULTIFRAME_STRING  "A000000017"
#define BINARY_FRAME_TYPE_STRING "B000000001"

#define WIDTH_STRING             "width="
#define HEIGHT_STRING            "height="

#define NEW_STRING_TYPEI16_XYC    "Type=i16 [X,Y,C]"
#define NEW_STRING_TYPEU32_XYC    "Type=u32 [X,Y,C]"
#define NEW_STRING_TYPEI16_MATRIX "Type=i16 matrix"
#define NEW_STRING_TYPEU32_MATRIX "Type=u32 matrix"

#define NEW_STRING_TYPEI16_XC     "Type=i16 [X,C]"
#define NEW_STRING_TYPEU32_XC     "Type=u32 [X,C]"
